...
import com.cryptocheck.microservices.btc.domain.service.SMACriteria;
...
@EnableWebMvc
public class BtcServiceControllerTest {
    ...
    @Autowired
    public IBtcH2Repository h2Repository;

    @Before
    public void init() {
        mockMvc = MockMvcBuilders.standaloneSetup(BtcServiceController.class).build();
    ...
    @Test
    public void getBtcPrice_NoParam_returnsPriceResponse() throws Exception {

        MvcResult result = mockMvc
                .perform(MockMvcRequestBuilders.post("/getBtcPrice")
    ...
    @Test
    public void getBtcPrice_WithSmaCriterias_returnsPriceResponse() {
        ...
        ResponseEntity<PriceResponse> response = testRestTemplate.postForEntity("/getBtcPrice",new HttpEntity<>(request, headers),
                PriceResponse.class);
