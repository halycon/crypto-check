...
import com.cryptocheck.microservices.eth.service.impl.EthPriceService;
...
@SpringBootTest
public class EthPriceServiceTest {

    private EthPriceService priceService;
    ...
    public void init(){
        ...
        priceService = new EthPriceService();
