...
public class NeoServiceControllerTest {
    ...
    public void getNeoPrice_WithSmaCriterias_returnsPriceResponse() {
        ...
        System.out.println("double value : "+response.getBody().getSmaPrice().doubleValue());
        Assert.assertTrue("sma price is greater than 0",response.getBody().getSmaPrice()!=BigDecimal.valueOf(0));
